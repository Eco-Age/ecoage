                ...
                <div class="form-group">
                  ...
                  <div class="avatar-container">
                    <?php foreach ($lista_avatar as $avatar) : ?>
                      <?php
                      $caminhoAjustado = str_replace('../', '', $avatar["caminho"]);
                      ?>
                      ...
                      <label for="avatar<?= $avatar["id_avatar"] ?>">
                        <img src="<?= $caminhoAjustado ?>" alt="<?= $avatar["nome"] ?>">
                      </label>
                    <?php endforeach ?>
                    ...
                    $caminhoAjustadoEscolhido = str_replace('../', '', $caminhoEscolhido);
                    $_SESSION["caminhoAvatar"] = $caminhoAjustadoEscolhido;
