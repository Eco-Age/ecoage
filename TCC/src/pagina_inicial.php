                ...
                <div id="carroselIntrod" class="carousel slide col-12" data-interval="30000" data-ride="carousel">
                    ...
                    <div class="carroselInicial carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div class="row">
                                <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3"></div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" id="texto_inicial_edu">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="row ">
                                <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3"></div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" id="texto_inicial_gabi">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="row ">
                                <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3"></div>
                                    <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6" id="texto_inicial_ana">
